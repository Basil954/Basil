                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @MORFE8\
                                  \n\n--------بـدء تتبـع سجـل زدثـــون بـاسل-------\
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار  باسل ✘**\n\n "
                        link = "[𐇮 باسل الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/MORFE8)"
