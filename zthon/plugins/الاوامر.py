...
#< https://t.me/Xl441 >
# This file is a part of < https://github.com/Zed-Thon/MORFE8/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Zed-Thon/MORFE8/blob/master/LICENSE/>.
...
#لـوحــة الاوامــر - حقــوق باسل
@zdub.tgbot.on(events.InlineQuery)
@chek_owner
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - اوامــر المجمــوعــه¹](t.me/Xl441) 𓆪\n\n**⎞𝟏⎝** `.البوتات`\n\n**⎞𝟐⎝** `.قفل البوتات` / `.فتح البوتات`\n\n**⎞𝟑⎝** `.قفل الاضافه` / `.فتح الاضافه`  \n\n**⎞𝟒⎝** `.قفل الدخول` / `.فتح الدخول `\n\n**⎞𝟓⎝** `.قفل الميديا` / `.فتح الميديا `\n\n**⎞𝟔⎝** `.قفل الفشار` / `.فتح الفشار`\n\n**⎞𝟕⎝** `.قفل الفارسيه` / `.فتح الفارسيه`\n\n**⎞𝟖⎝** `.قفل الروابط` / `.فتح الروابط`\n\n**⎞𝟗⎝**`.قفل المعرفات` / `.فتح المعرفات`\n\n**⎞𝟏𝟎⎝** `.قفل الانلاين` / `.فتح الانلاين`\n\n**⎞𝟏𝟏⎝** `.قفل الكل` / `.فتح الكل`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/ZedThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - اوامــر الحســاب 🚹](t.me/Xl441) 𓆪\n\n**⎞𝟏⎝** `.ايدي` / `.ا`\n\n**⎞𝟐⎝** `.الايدي`\n\n**⎞𝟑⎝** `.صورته`\n\n**⎞𝟒⎝** `.اسمه`\n\n**⎞𝟓⎝** `.الاسماء`\n\n**⎞𝟔⎝** `.المعرفات`\n\n**⎞𝟕⎝** `.تخزين الخاص تفعيل`\n\n**⎞𝟖⎝** `.تخزين الكروبات تفعيل`\n\n\n**- اوامــر حمـايــة الخــاص🛡 :**\n\n**⎞𝟗⎝** `.الحمايه تفعيل`\n\n**⎞𝟏𝟎⎝** `.الحمايه تعطيل`\n\n**⎞𝟏𝟏⎝** `.قبول`\n\n**⎞𝟏𝟐⎝** `.رفض`\n\n**⎞𝟏𝟑⎝** `.مرفوض`\n\n**⎞𝟏𝟒⎝** `.المقبولين`\n\n\n**- اوامــر الحظــر - الكتــم - الطــرد 🔕 :**\n\n**⎞𝟏𝟓⎝** `.حظر`  /  `.الغاء حظر`\n\n**⎞𝟏𝟔⎝** `.كتم`  /  `.الغاء كتم`\n\n**⎞𝟏𝟕⎝** `.طرد`\n\n**⎞𝟏𝟖⎝** `.ح عام`\n\n**⎞𝟏𝟗⎝** `.الغاء ح عام`\n\n**⎞𝟐𝟎⎝** `.ك عام`\n\n**⎞𝟐𝟏⎝** `.الغاء ك عام`\n\n**⎞𝟐𝟐⎝** `.ط عام`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/ZedThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"ahmed7")))
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - اوامــر تحـويـل الصيــغ 💡🎞](t.me/Xl441) 𓆪\n\n**⎞𝟏⎝** `.ملصق`\n\n**⎞𝟐⎝** `.حزمه`\n\n**⎞𝟑⎝** `.صورته`\n\n**⎞𝟒⎝** `.معلومات الملصق`\n\n**⎞𝟓⎝** `.ملصقات`\n\n**⎞𝟔⎝** `.لملصق`\n\n**⎞𝟕⎝** `.لصوره`\n\n**⎞𝟖⎝** `.لفيد`\n\n**⎞𝟗⎝** `.دائري`\n\n**⎞𝟏𝟎⎝** `.لمتحركة`\n\n**⎞𝟏𝟏⎝** `.حول بصمه`\n\n**⎞𝟏𝟑⎝** `.حول صوت`\n\n**⎞𝟏𝟒⎝** `.لمتحركه`\n\n**⎞𝟏𝟓⎝** `.لمتحرك`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/ZedThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - اوامــر الـخدمــات العـامــه](t.me/Xl441) 𓆪\n\n**⎞𝟏⎝** `.التخصيص`\n\n**⎞𝟐⎝** `.الترحيب`\n\n**⎞𝟑⎝** `.الردود`\n\n**⎞𝟒⎝** `.الاذاعه`\n\n**⎞𝟓⎝** `.النشر`\n\n**⎞𝟔⎝** `.الكاشف`\n\n**⎞𝟕⎝** `.المساعد`\n\n**⎞𝟖⎝** `.الطقس`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/ZedThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"ahmad10")))
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - اوامــر الالـعــاب 🎮🎳 ](t.me/Xl441) 𓆪\n\n**⎞𝟏⎝** `.بلاي` \n**- العــاب الانـلايـن لســورس زدثـــون 🕹\n\n**⎞𝟐⎝** `.كت`\n**- اسئلـة كـت تـويت ⁉️**\n\n**⎞𝟑⎝** `.احكام`\n**- لعبــة احكــام الشهيــرة ⚖👩🏻‍⚖**\n\n**⎞𝟒⎝** `.عقاب`\n**- لعبــة عقــاب ⛓**\n\n**⎞𝟓⎝** `.اكس او`\n**- لعبــة اكـس او 🧩**\n\n**⎞𝟔⎝** `.نرد`\n**- لعبــة رمـي النــرد 🎲**\n\n**⎞𝟕⎝** `.سهم`\n**- لعبــة رمـي السهــم 🎯**\n\n**⎞𝟖⎝** `.سله`\n**- لعبــة كــرة السلــة 🏀**\n\n**⎞𝟗⎝** `..كرة`\n**- لعبــة كــرة القــدم ⚽️**\n\n**⎞𝟏𝟎⎝** `.حظ`\n**- لعبــة الحــظ 🎰**\n\n**⎞𝟏𝟏⎝** `.خيرني`\n**- لعبــة لـو خيـروك بالصـور ⁉️🌉**\n\n**⎞𝟏𝟐⎝** `.تويت`\n**- لعبــة كـت تـويت بالصـور ⁉️🌁**\n\n\n**- سيتـم اضـافــة المـزيــد من الالعــاب بالتحديثــات الجــايـه 🎭**"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝗕𝗮𝘀𝗶𝗹 𝗩 - اوامــر الستـوريـات 🎆🏖](t.me/) 𓆪\n\n**⎞𝟏⎝** `.حالات واتس`\n**- اكثـر مـن 2000 فيديـو حالات واتسـاب قصيـرة 🎬**\n\n**⎞𝟐⎝**`.ستوري انمي`\n**- مقاطـع ستوريـات انمـي قصيـرة 🎞**\n\n**⎞𝟑⎝** `.ادت`\n**- مقاطـع ادت منـوعـة 🎥**\n\n**⎞𝟒⎝** `.رياكشن`\n**- مقاطـع رياكشـن ترفيهيــه 📺**\n\n**⎞𝟓⎝** `.ميمز`\n**- بصمـات ميمـز تحشيـش 🎃**\n\n**⎞𝟔⎝** `.غنيلي`\n**- مقاطـع اغـانـي قصيـره 🎶**\n\n**⎞𝟕⎝** `.شعر`\n**- مقاطـع صـوت شعـريـه 🎙**\n\n**⎞𝟖⎝** `.رقيه`\n**- رقيـه شرعيـة لعـدة مشائـخ 🕋**\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/ZedThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"ahmad14")))
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝗕𝗮𝘀𝗶𝗹 𝗩 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/Xl441) 𓆪\n\n**⎞𝟏⎝** `.ولد انمي`\n**- اكثـر مـن 2500 آفتـار آنمـي شبـاب 🙋🏻‍♂🎆**\n\n**⎞𝟐⎝**`.بنت انمي`\n**- اكثـر مـن 1800 آفتـار آنمـي بنـات 🙋🏻‍♀🎆**\n\n**⎞𝟑⎝** `.رمادي`\n**- آفتـارات شبـاب رمـاديـه 🏂🏙**\n\n**⎞𝟒⎝** `.رماديه`\n**- آفتـارات بنـات رمـاديـه ⛹🏻‍♀🌁**\n\n**⎞𝟓⎝** `.بيست`\n**- آفتـارات بيست تطقيـم بنـات 👯‍♀🏖**\n\n**⎞𝟔⎝** `.حب`\n**- آفتـارات بيست تطقيـم حب ♥️🧚‍♂🧚‍♀**\n\n**⎞𝟕⎝** `.ري اكشن`\n**- صـور رياكشـن تحشيـش 🎃😹**\n\n**⎞𝟖⎝** `.معلومه`\n**- صـوره ومعلومـه معلومـات عـامـه 🗺**\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/ZedThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
...
async def zed_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("باسل") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/1035d07280ee0ec9fc29b.mp4"
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/Xl441"),],[Button.url("التحـديثـات", "https://t.me/ooxxoop"), Button.url("الفـارات", "https://t.me/zzzvrr"),],[Button.url("الشـروحـات¹", "https://t.me/zzzlvv"),],[Button.url("الشـروحـات²", "https://t.me/W_l_N"),],[Button.url("مطـور السـورس", "https://t.me/zzzzl1l"),]]
...
async def repozedub(event):
    ...
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(TG_BOT, "باسل")
    await response[0].click(event.chat_id)
    await event.delete()


@zdub.tgbot.on(InlineQuery)
@ceck_owner
async def zed_handler(event):
    builder = event.builder
    result = None
    ...
    if query.startswith("سورس") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC") or "https://te.legra.ph/file/b1b398463cce541420615.jpg"
        buttons = [[Button.url("قنـاة الســورس", "https://t.me/Xl441"), Button.url("مطـور الســورس" "https://t.me/MORFE8")]]
...
async def repozedub(event):
    ...
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(T_BOT, "سورس")
    await response[0].click(event.chat_id)
    await event.delete()
